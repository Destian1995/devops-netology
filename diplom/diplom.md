...
Так же отмечаю что качество отработки скрипта полной установки зависит от качество сети(скорость\стабильность). При развертывании случались проблемы с тем что terraform мог не прокинуть ключи ssh на хосты. Либо один из серверов был недоступен во время конфигурирования кластера. Вообщем любые проблемы(за исключением окружения потому что у меня оно устанавливалось по разному) это сугубо сетевые проблемы.
