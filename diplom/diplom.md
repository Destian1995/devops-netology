...
[Демонстрация создания всех ресурсов с нуля](https://www.youtube.com/watch?v=eQGPXB3GB2w)

1. [Репозиторий](https://github.com/Destian1995/diplom_netology) со всеми файлами необходимыми для развертывания полноценной инфраструктуры.
...
Так же отмечаю что качество отработки скрипта полной установки зависит от качества сети(скорость\стабильность).
...
6.
* [Ссылка на приложение](http://84.252.128.123:30080)
* [Cсылка на Grafana](http://84.252.128.123:30030)
```   
Логин: admin 
